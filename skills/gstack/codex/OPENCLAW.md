...
3. `/codex` with no arguments — **Auto-detect:**
   ...
   - If a diff exists, use ask the user directly in chat:
     ```
...
Use `timeout: 300000` on the exec call. If the user provided custom instructions
...
```bash
/home/keep/.openclaw/workspace//home/keep/.openclaw/workspace/skills/gstack/bin/gstack-review-log '{"skill":"codex-review","timestamp":"TIMESTAMP","status":"STATUS","gate":"GATE","findings":N,"findings_fixed":N}'
```
...
If a session file exists (not `NO_SESSION`), use ask the user directly in chat:
```
...
- **5-minute timeout** on all exec calls to codex (`timeout: 300000`).
