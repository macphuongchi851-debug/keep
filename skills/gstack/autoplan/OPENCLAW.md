...
manually. The only difference: intermediate ask the user directly in chat calls are auto-decided using
...
ask the user directly in chat: you do, using the 6 principles, instead of the user.
...
- `/home/keep/.openclaw/workspace//home/keep/.openclaw/workspace/skills/gstack/plan-ceo-review/SKILL.md`
- `/home/keep/.openclaw/workspace//home/keep/.openclaw/workspace/skills/gstack/plan-design-review/SKILL.md` (only if UI scope detected)
- `/home/keep/.openclaw/workspace//home/keep/.openclaw/workspace/skills/gstack/plan-eng-review/SKILL.md`
...
Override: every ask the user directly in chat → auto-decide using the 6 principles.

**Override rules:**
- Mode selection: SELECTIVE EXPANSION
- Premises: accept reasonable ones (P6), challenge only clearly wrong ones
- **GATE: Present premises to user for confirmation** — this is the ONE ask the user directly in chat
...
Present as a message, then use ask the user directly in chat:
...
ask the user directly in chat options:
...
/home/keep/.openclaw/workspace//home/keep/.openclaw/workspace/skills/gstack/bin/gstack-review-log '{"skill":"plan-ceo-review","timestamp":"'"$TIMESTAMP"'","status":"clean","unresolved":0,"critical_gaps":0,"mode":"SELECTIVE_EXPANSION","via":"autoplan","commit":"'"$COMMIT"'"}'

/home/keep/.openclaw/workspace//home/keep/.openclaw/workspace/skills/gstack/bin/gstack-review-log '{"skill":"plan-eng-review","timestamp":"'"$TIMESTAMP"'","status":"clean","unresolved":0,"critical_gaps":0,"issues_found":0,"mode":"FULL_REVIEW","via":"autoplan","commit":"'"$COMMIT"'"}'
```

If Phase 2 ran (UI scope):
```bash
/home/keep/.openclaw/workspace//home/keep/.openclaw/workspace/skills/gstack/bin/gstack-review-log '{"skill":"plan-design-review","timestamp":"'"$TIMESTAMP"'","status":"clean","unresolved":0,"via":"autoplan","commit":"'"$COMMIT"'"}'
```
...
- **Premises are the one gate.** The only non-auto-decided ask the user directly in chat is the premise confirmation in Phase 1.
